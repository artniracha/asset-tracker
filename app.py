...
@st.cache_data(ttl=60) # ปรับเวลาลงเหลือ 1 นาทีชั่วคราวเพื่อทดสอบระบบ
def load_data():
...
try:
    ...
    # ส่วนสำคัญ: สั่งให้แสดงข้อผิดพลาดที่แท้จริงออกมาทางหน้าจอเว็บแอป
    st.error("❌ ระบบไม่สามารถเชื่อมต่อฐานข้อมูลได้")
    st.markdown("### 📋 ข้อความข้อผิดพลาด (โปรดส่งข้อความด้านล่างนี้ให้ฉัน):")
